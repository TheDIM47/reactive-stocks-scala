...
object Settings {
  ...
  object versions {
    val name = "reactive-stocks-scala"
...
//    "org.webjars" % "bootstrap-glyphicons" % "bdd2cbfba0",
    "org.webjars" % "font-awesome" % "4.4.0" % Provided,
...
//    "be.doeraene" %%% "scalajs-jquery" % versions.scalaJsJQuery,
  ...
  val jsDependencies = Def.setting(Seq(
    ...
    "org.webjars" % "bootstrap" % versions.bootstrap / "bootstrap.js" minified "bootstrap.min.js" dependsOn s"${versions.jQuery}/jquery.js",
